...
import org.openqa.grid.e2e.utils.PortGenerator;
...
public class Selenium1WebDriverTests {
	...
	private Hub hub = Hub.getNewInstanceForTest(PortGenerator.getNewPort(), Registry.getNewInstanceForTestOnly());
	...
	public void setup() throws Exception {
		...
		SelfRegisteringRemote selenium1 = SelfRegisteringRemote.create(SeleniumProtocol.Selenium, PortGenerator.getNewPort(), hub.getRegistrationURL());
		...
		SelfRegisteringRemote webdriver = SelfRegisteringRemote.create(SeleniumProtocol.WebDriver, PortGenerator.getNewPort(), hub.getRegistrationURL());
