...
public class MultiRCTest {
	...
	public void prepare() throws Exception {
		...
		for (int i = 0; i < 5; i++) {
			SelfRegisteringRemote remote = SelfRegisteringRemote.create(SeleniumProtocol.Selenium, PortGenerator.getNewPort(), hub
					.getRegistrationURL());
	...
	@Test(dependsOnMethods = "multifirefox", timeOut = 10000)
