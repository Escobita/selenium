...
public class EndToEndWebDriver {
	...
	public void prepare() throws Exception {
		...
		SelfRegisteringRemote remote = SelfRegisteringRemote.create(SeleniumProtocol.WebDriver, PortGenerator.getNewPort(), hub.getRegistrationURL());
		...
		SelfRegisteringRemote remote2 = SelfRegisteringRemote
				.create(SeleniumProtocol.WebDriver, PortGenerator.getNewPort(), hub.getRegistrationURL());
