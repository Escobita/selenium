...
package com.serli.helium.picture.editor.handlers.operations;
...
/**
 * The AddTextVerification operation
 * 
 * @author Kevin Pollet
 */

public class AddPictureTextVerificationOperation extends AbstractOperation {
...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/	
	...
	public AddPictureTextVerificationOperation( PictureModel model ) {
		super( "Add picture text verification" );
