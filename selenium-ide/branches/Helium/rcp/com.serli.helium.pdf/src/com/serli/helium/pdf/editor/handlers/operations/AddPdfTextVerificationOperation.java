...
/**
 * The AddPdfTextVerification operation for undo/redo purpose.
 * 
 * @author Kevin Pollet
 */

public class AddPdfTextVerificationOperation extends AbstractOperation {
...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/	
	...
	public AddPdfTextVerificationOperation( PdfModel model ) {
		super( "Add pdf text verification" );
