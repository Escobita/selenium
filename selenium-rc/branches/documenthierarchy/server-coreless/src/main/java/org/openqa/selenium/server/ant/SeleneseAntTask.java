...
public class SeleneseAntTask extends Task {
	...
	private int port = (Integer)SeleniumConfigurationOption.PORT.getDefaultValue();
	private int timeoutInSeconds = (Integer)SeleniumConfigurationOption.TIMEOUT.getDefaultValue();
