...
/*
 * HtmlIdentifierManager: a module to identify HTML (and in so doing determine whether it should be
...
public class HtmlIdentifierManager {
	private static Logger logger = Logger.getLogger(HtmlIdentifierManager.class);	
    ...
    public HtmlIdentifierManager(SeleniumConfiguration seleniumConfiguration) {
