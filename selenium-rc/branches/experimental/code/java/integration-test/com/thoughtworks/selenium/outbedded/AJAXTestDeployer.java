 ...
 */
public class AJAXTestDeployer implements Deployer {
...
//        container.installWebApp(new File("C:/Dan/scratch/myfaces-1.1.1-examples/sandbox.war"),appContext);
        container.installWebApp(new File(calculateCodeRoot(), "ajax/sandbox"),appContext);
        //container.installWebApp(new File("C:/jakarta-tomcat-5.0.28-j2re-1.4.2_06-windows/webapps/sandbox"),appContext);
    }
