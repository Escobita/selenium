...
public class GetCurrentUrlIntentReceiver extends BroadcastReceiver {
  ...
  public void onReceive(Context context, Intent intent) {
    ...
    String url =
        SessionRepository.getInstance().getById(sessId).getLastUrl();
    Bundle res = new Bundle();
    res.putString("URL", url);
    Log.d("WebDriver", "Returning URL: " + url);
