...
public class JsApiTestCase extends TestCase {
  ...
  private final JsApiClosure<WebDriver> driverClosure;

  public JsApiTestCase(URL testUrl, JsApiClosure<WebDriver> driverClosure) {
    this.testUrl = testUrl;
    this.driverClosure = driverClosure;
    this.setName(testUrl.getPath());
  }

  @Override
  protected void runTest() throws Throwable {
    WebDriver driver = driverClosure.get();
